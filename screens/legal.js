    ...
    return(
        <View style={styles.container}>
            <Text>By using this application, you agree that PNCC is not responsible for the inaccuracy and inappropriateness of the information or material contained on any web sites viewed on or downloaded from the Internet using PNCC service.
                ...
                You are reminded to comply with all local laws, rules and regulations, and you will be solely responsible for any breaches of the law. Refrain from downloading COPYRIGHTED MATERIALS. IP and MAC Addresses are being monitored by international copyright holders for such activities.
            </Text>
        </View>
    );
};
